...
foreach($arrRegionsByQuery as $sQueryName => $arrRegions) {
	...
	$arrTopBlocks = $arrTopBlocks + fnGetTopBlocks(fnFindHitBlocks($arrRegionsByQuery[$sQueryName], true) , fnFindHitBlocks($arrRegionsByQuery[$sQueryName], false), 1); //get the best 2 blocks 
