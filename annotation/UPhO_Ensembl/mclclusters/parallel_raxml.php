<?php
$sRAxMLCmd = "/beegfs/group_dv/software/source/standard-RAxML-8.2.9/raxmlHPC-PTHREADS-SSE3 -T 40 -f a -p 767 -x 23333 -#100 -m PROTGAMMAJTTX";
$nTotalParts = 1;
$nThisPart = 0;
...
while( false!== ($sLn = fgets($hFileList) ) ) {
	...
	exec("cd $sDIR; $sRAxMLCmd -s $sLn -n $sOutStem");
