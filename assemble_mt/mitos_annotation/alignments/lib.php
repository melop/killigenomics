...
function fnTranslatorX($arrSeqs , $nPMinSeqConsv=0.75, $nPMinSeqFlank = 0.85, $nMinContNonConsv=2, $nMinBlockLen=5, $nExcludeBelow=0.1, $nCode=1) { //if lower than 10% left after trimming, exclude
	...
	exec("cd $sTmp; perl ".TRANSLATORX_PATH." -c $nCode  -i in.fa -o tranX -p F -c 1 -g \"-b1=$nMinSeqConsv -b2=$nMinSeqFlank -b3=$nMinContNonConsv -b4=$nMinBlockLen -b5=h\" > tr.log 2>&1; cd ../../");
