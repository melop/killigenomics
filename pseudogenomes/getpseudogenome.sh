...
mkdir ./testaln
hhvm getAlignmentAllowN.php -n yes -q 1 -D no -w 1000000000 -c alltaxa.txt -R charRequirements.txt -s 1 -l 10 -d 1 -N no -r 1 -o ./testaln -I yes -b no -M yes
[ $? -ne 0 ] &&  exit 1 ;
...
( hhvm phy2fasta.php -R $sRefGenome -L ${i} -o ${i}_pseudogenome2.fasta ; fastahack -i ${i}_pseudogenome2.fasta ) &
