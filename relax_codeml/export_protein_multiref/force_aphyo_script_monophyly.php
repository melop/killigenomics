...
//$sMonoDesc = "monophyly_force_aphy_script_monophyly.txt";
$sMonoDesc = "monophyly_force_aphy_script_monophyly3.txt";

//$sPremadeFasta = "ret_cleanDNA.fasta"; //ret_improved_cleanDNA.fasta
//$sOutDIR = "genetrees";

$sPremadeFasta = "ret_improved_cleanDNA.fasta";
//$sOutDIR = "genetrees_forced_aphy_script_monophyly";
$sOutDIR = "genetrees_forced_aphy_script_monophyly3";
