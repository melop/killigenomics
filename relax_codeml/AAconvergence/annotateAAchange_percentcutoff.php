...
function fnProcessAln($sGeneName,$arrFullCodingSeq) {
	global $sOutDIR, $sMonoDesc, $nThisPart, $nTotalPart, $nGeneCount,$hOut, $arrOutgroupGenera , $arrConvergenceGenera, $nMinTargetTaxaWithDerivedAAPerGenusPerc, $nMaxAAStatesInOutgroup,$nTotalSitesExamined;
