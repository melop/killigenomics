...
### Change testing HERE ###
$TestIntensified = false;
$TestRelaxation = false;
$TestPositivSelection = false;
$TestRelaxation_and_PositivSelection=false;
$TestIntensification_and_PositivSelection=true;
### Change testing HERE ###
...
// path to table
$RELAXRet= "/beegfs/group_dv/home/RCui/killifish_genomes/hyphyrelax/relax_46_spp/rerun_omega0/sum_Scriptaphyosemion.txt";
$sCodemlRet = "/beegfs/group_dv/home/RCui/killifish_genomes/hyphyrelax/codeml_46_spp/sum_Scriptaphyosemion.txt";
...
$sIsForgroundClade= "Scriptaphyosemion";
$processONE=null;
$pipesONE	= array();
$descONE 	= array(
		0	=> array('pipe','r'),
...
if($TestIntensified ){
	$arrDrawKParameter= array(4,5,6);
	} 
else if ($TestIntensification_and_PositivSelection) {
	$arrDrawKParameter= array(4,5,3);
}
...
function fnCollectSimInfo($sCodeml3Out, $arrRelaxRecord, $sGroup) {
	...
	global $TestRelaxation, $TestPositivSelection, $TestRelaxation_and_PositivSelection, $nForegroundForBG0, $nMaxPosOmega, $TestIntensification_and_PositivSelection;
	...
	*/
	...
	if($TestIntensification_and_PositivSelection) {
			$arrOmegasRELAX= array(		
			...
			if ($arrRelaxRecord[0] == 0) { // if the background is 0, set background to 0 and foreground to nForegroundForBG0
				$arrOmegasRELAX[0][1] = $nForegroundForBG0;
			} 
