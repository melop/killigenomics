...
function fnCollectSimInfo($sCodeml3Out, $arrRelaxRecord, $sGroup) {
	...
	global $TestRelaxation, $TestPositivSelection, $TestRelaxation_and_PositivSelection,$TestIntensified, $nForegroundForBG0 ;
...
if($TestRelaxation_and_PositivSelection) {
			$arrOmegasRELAX= array(		
					array(pow($arrRelaxRecord[0] , $arrDrawnOmegasK[0]),$arrRelaxRecord[0]),
					array(pow($arrRelaxRecord[2] , $arrDrawnOmegasK[1]),$arrRelaxRecord[2]),
					array(pow($arrRelaxRecord[4] , $arrDrawnOmegasK[2]),$arrRelaxRecord[4]));
...
if($TestIntensified) {
		if($arrRelaxRecord[0]==0){
		$arrOmegasRELAX= array(
					array($arrRelaxRecord[0],$nForegroundForBG0), //set background to the average omega<0, around 0.2
					array(pow($arrRelaxRecord[2] , $arrDrawnOmegasK[1]),$arrRelaxRecord[2]),
					array(pow($arrRelaxRecord[4] , $arrDrawnOmegasK[2]),$arrRelaxRecord[4]));
					} else {
