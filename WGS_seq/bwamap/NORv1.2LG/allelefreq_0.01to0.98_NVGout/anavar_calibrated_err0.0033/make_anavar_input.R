setwd("/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/NORv1.2LG/allelefreq_0.01to0.98_NVGout/anavar_calibrated_err0.0033/");

nChromosomes <- 50; #set chromosome to 50. this is "n" in the anavar configuration file
#sPop <- "RACDRY.excludehybrid";
#sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov/allelefreq_0.01to0.98_NVGout/accuracy/RACDRY.acc.txt";

#sPop <- "RACWET.excludehybrid";
#sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov/allelefreq_0.01to0.98_NVGout/accuracy/RACWET.acc.txt";

#sPop <- "ORTDRY.excludehybrid";
#sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov/allelefreq_0.01to0.98_NVGout/accuracy/ORTDRY.acc.txt";

sPop <- "ORTWET";
sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov/allelefreq_0.01to0.98_NVGout/accuracy/ORTWET.acc.txt";
