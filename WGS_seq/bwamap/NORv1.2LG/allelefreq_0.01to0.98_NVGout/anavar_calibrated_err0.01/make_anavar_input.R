...
sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov_err0.01/allelefreq_0.01to0.98_NVGout/accuracy/RACDRY.acc.txt";

sPop <- "RACWET.excludehybrid";
sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov_err0.01/allelefreq_0.01to0.98_NVGout/accuracy/RACWET.acc.txt";

sPop <- "ORTDRY.excludehybrid";
sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov_err0.01/allelefreq_0.01to0.98_NVGout/accuracy/ORTDRY.acc.txt";

sPop <- "ORTWET";
sCalibration <- "/beegfs/group_dv/home/RCui/killifish_genomes/WGS_seq/bwamap/SimNORLG1_hicov_err0.01/allelefreq_0.01to0.98_NVGout/accuracy/ORTWET.acc.txt";
