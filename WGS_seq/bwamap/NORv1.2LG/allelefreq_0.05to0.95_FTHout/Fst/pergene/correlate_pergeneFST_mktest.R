...
sMKFile <- paste("../../../allelefreq_lowfreq_excl/MKTEST_syn",sSuffix,"/",sFileName, ".pergene.alpha.txt", sep="");

#sMKFile <- paste("../../../allelefreq_0.02to0.2_NVGout/MKTEST_syn",sSuffix,"/",sFileName, ".pergene.alpha.txt", sep="");
#sMKFile <- paste("../../../allelefreq_below0.2_NVGout/MKTEST_syn",sSuffix,"/",sFileName, ".pergene.alpha.txt", sep="");
...
abline(a=oFit$coefficients[1,1], b=oFit$coefficients[2,1], col=sColor)
#dev.off();